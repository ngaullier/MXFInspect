...
namespace Myriadbits.MXF
{
	...
	public class MXFKLVFactory
	{
		...
		static MXFKLVFactory()
		{
            ...
            m_allKeys.Add(new MXFKey(typeof(MXFPartition),								0x06, 0x0e, 0x2b, 0x34, 0x02, 0x05, 0x01, 0x01, 0x0d, 0x01, 0x02, 0x01, 0x01, 0x02));				// Header partition
			m_allKeys.Add(new MXFKey(typeof(MXFPartition),								0x06, 0x0e, 0x2b, 0x34, 0x02, 0x05, 0x01, 0x01, 0x0d, 0x01, 0x02, 0x01, 0x01, 0x03));				// Body partition
			m_allKeys.Add(new MXFKey(typeof(MXFPartition),								0x06, 0x0e, 0x2b, 0x34, 0x02, 0x05, 0x01, 0x01, 0x0d, 0x01, 0x02, 0x01, 0x01, 0x04));				// Footer partition
			...
			// EncryptedTriplet – urn: smpte: ul: 060e2b34.027f0101.0d010301.027e0100 ???
			...
			// CryptographicContext – urn: smpte: ul: 060e2b34.027f0101.0d010401.02020000
			m_allKeys.Add(new MXFKey(typeof(MXFCryptographicContext),					0x06, 0x0e, 0x2b, 0x34, 0x02, 0x53, 0x01, 0x01, 0x0d, 0x01, 0x04, 0x01, 0x02, 0x02, 0x00, 0x00));
            #endregion
			...
			m_allKeys.Add(new MXFKey(typeof(MXFDescriptiveMarker),						0x06, 0x0e, 0x2b, 0x34, 0x02, 0x53, 0x01, 0x01, 0x0d, 0x01, 0x01, 0x01, 0x01, 0x01, 0x41, 0x00)); // Descriptive Marker

			// CommentMarker 
			// urn:smpte:ul:060e2b34.027f0101.0d010101.01010800
			m_allKeys.Add(new MXFKey(typeof(MXFCommentMarker),							0x06, 0x0e, 0x2b, 0x34, 0x02, 0x53, 0x01, 0x01, 0x0d, 0x01, 0x01, 0x01, 0x01, 0x01, 0x08, 0x00));
			...
			m_allKeys.Add(new MXFKey(typeof(MXFDescriptiveClip),						0x06, 0x0e, 0x2b, 0x34, 0x02, 0x53, 0x01, 0x01, 0x0d, 0x01, 0x01, 0x01, 0x01, 0x01, 0x60, 0x00)); // Package marker object
			...
			m_allKeys.Add(new MXFKey(typeof(TargetFrameSubDescriptor),					0x06, 0x0e, 0x2b, 0x34, 0x02, 0x53, 0x01, 0x01, 0x0d, 0x01, 0x01, 0x01, 0x01, 0x01, 0x7a, 0x00));

            // JPEG 2000 SubDescriptor per SMPTE ST 422 
		    // urn:smpte:ul:060e2b34.027f0101.0d010101.01015a00
            m_allKeys.Add(new MXFKey(typeof(JPEG2000SubDescriptor),						0x06, 0x0e, 0x2b, 0x34, 0x02, 0x53, 0x01, 0x01, 0x0d, 0x01, 0x01, 0x01, 0x01, 0x01, 0x5a, 0x00));
			...
			m_allKeys.Add(new MXFKey(typeof(MXFContainerConstraintsSubDescriptor),		0x06, 0x0e, 0x2b, 0x34, 0x02, 0x53, 0x01, 0x01, 0x0d, 0x01, 0x01, 0x01, 0x01, 0x01, 0x67, 0x00));
			m_allKeys.Add(new MXFKey(typeof(MXFAVCSubDescriptor),						0x06, 0x0e, 0x2b, 0x34, 0x02, 0x53, 0x01, 0x01, 0x0d, 0x01, 0x01, 0x01, 0x01, 0x01, 0x6e, 0x00));
			#endregion

			#region DescriptveObjects
			m_allKeys.Add(new MXFKey(typeof(MXFGenericStreamTextBasedSet),				0x06, 0x0e, 0x2b, 0x34, 0x02, 0x53, 0x01, 0x01, 0x0d, 0x01, 0x04, 0x01, 0x04, 0x02, 0x01, 0x00));
			m_allKeys.Add(new MXFKey(typeof(MXFTextBasedObject),						0x06, 0x0e, 0x2b, 0x34, 0x02, 0x53, 0x01, 0x01, 0x0d, 0x01, 0x04, 0x01, 0x04, 0x03, 0x01, 0x00));

			// DescriptiveObject	
			// urn:smpte:ul:060e2b34.027f0101.0d010400.00000000
			m_allKeys.Add(new MXFKey(typeof(MXFDescriptiveObject),						0x06, 0x0e, 0x2b, 0x34, 0x02, 0x53, 0x01, 0x01, 0x0d, 0x01, 0x04, 0x01, 0x00, 0x00, 0x00, 0x00));

			// Thesaurus
			// urn:smpte:ul:060e2b34.027f0101.0d010401.017f1200
			m_allKeys.Add(new MXFKey(typeof(MXFThesaurus),								0x06, 0x0e, 0x2b, 0x34, 0x02, 0x53, 0x01, 0x01, 0x0d, 0x01, 0x04, 0x01, 0x01, 0x7f, 0x12, 0x00));

			// Contact 
			// urn:smpte:ul:060e2b34.027f0101.0d010401.017f1a00 
			m_allKeys.Add(new MXFKey(typeof(MXFContact),								0x06, 0x0e, 0x2b, 0x34, 0x02, 0x53, 0x01, 0x01, 0x0d, 0x01, 0x04, 0x01, 0x01, 0x7f, 0x1a, 0x00));

			// Location
			// urn:smpte:ul:060e2b34.027f0101.0d010401.011a0400
			m_allKeys.Add(new MXFKey(typeof(MXFLocation),								0x06, 0x0e, 0x2b, 0x34, 0x02, 0x53, 0x01, 0x01, 0x0d, 0x01, 0x04, 0x01, 0x01, 0x1a, 0x04, 0x00));

			// ContactsList
			// urn:smpte:ul:060e2b34.027f0101.0d010401.01190100
			m_allKeys.Add(new MXFKey(typeof(MXFContactsList),							0x06, 0x0e, 0x2b, 0x34, 0x02, 0x53, 0x01, 0x01, 0x0d, 0x01, 0x04, 0x01, 0x01, 0x19, 0x01, 0x00));

			// Address
			// urn:smpte:ul:060e2b34.027f0101.0d010401.011b0100
			m_allKeys.Add(new MXFKey(typeof(MXFAddress),								0x06, 0x0e, 0x2b, 0x34, 0x02, 0x53, 0x01, 0x01, 0x0d, 0x01, 0x04, 0x01, 0x01, 0x1b, 0x01, 0x00));

			#endregion

			#region DescriptiveFrameworks
			m_allKeys.Add(new MXFKey(typeof(MXFTextBasedFramework),						0x06, 0x0e, 0x2b, 0x34, 0x02, 0x53, 0x01, 0x01, 0x0d, 0x01, 0x04, 0x01, 0x04, 0x01, 0x01, 0x00));

			// ProductionFramework 
			// urn:smpte:ul:060e2b34.027f0101.0d010401.01010100
			m_allKeys.Add(new MXFKey(typeof(MXFProductionFramework),					0x06, 0x0e, 0x2b, 0x34, 0x02, 0x53, 0x01, 0x01, 0x0d, 0x01, 0x04, 0x01, 0x01, 0x01, 0x01, 0x00));

			// ProductionClipFramework 
			// urn:smpte:ul: 060e2b34.027f0101.0d010401.017f0200
			m_allKeys.Add(new MXFKey(typeof(MXFProductionClipFramework),				0x06, 0x0e, 0x2b, 0x34, 0x02, 0x53, 0x01, 0x01, 0x0d, 0x01, 0x04, 0x01, 0x01, 0x7f, 0x02, 0x00));

			// DMS1Framework 
			// urn:smpte:ul:060e2b34.027f0101.0d010401.017f0100
			m_allKeys.Add(new MXFKey(typeof(MXFDMS1Framework),							0x06, 0x0e, 0x2b, 0x34, 0x02, 0x53, 0x01, 0x01, 0x0d, 0x01, 0x04, 0x01, 0x01, 0x7f, 0x01, 0x00));

			// DescriptiveFramework
			// urn:smpte:ul:060e2b34.027f0101.0d010401.00000000
			m_allKeys.Add(new MXFKey(typeof(MXFDescriptiveFramework),					0x06, 0x0e, 0x2b, 0x34, 0x02, 0x53, 0x01, 0x01, 0x0d, 0x01, 0x04, 0x01, 0x00, 0x00, 0x00, 0x00));
			#endregion
			...
			m_allKeys.Add(new MXFKey(typeof(MXFXMLDocumentText_Indirect),				0x06, 0x0e, 0x2b, 0x34, 0x01, 0x01, 0x01, 0x05, 0x03, 0x01, 0x02, 0x20, 0x01, 0x00, 0x00, 0x00));

			// ItemValue_ISO7
			//urn:smpte:ul:060e2b34.01010105.0301020a.02000000
			m_allKeys.Add(new MXFKey(typeof(MXFItemValue_ISO7),							0x06, 0x0e, 0x2b, 0x34, 0x01, 0x01, 0x01, 0x05, 0x03, 0x01, 0x02, 0x0a, 0x02, 0x00, 0x00, 0x00));

			// LensUnitAcquisitionMetadata 
			// urn:smpte:ul:060e2b34.027f0101.0c020101.01010000
			m_allKeys.Add(new MXFKey(typeof(MXFLensUnitAquisitionMetadata),				0x06, 0x0e, 0x2b, 0x34, 0x02, 0x53, 0x01, 0x01, 0x0c, 0x02, 0x01, 0x01, 0x01, 0x01, 0x00, 0x00));

			// CameraUnitAcquisitionMetadata 
			// urn:smpte:ul:060e2b34.027f0101.0c020101.02010000
			m_allKeys.Add(new MXFKey(typeof(MXFCameraUnitAquisitionMetadata),			0x06, 0x0e, 0x2b, 0x34, 0x02, 0x53, 0x01, 0x01, 0x0c, 0x02, 0x01, 0x01, 0x02, 0x01, 0x00, 0x00));
